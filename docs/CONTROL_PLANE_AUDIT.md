...
| 41. Administration API | Persistent CRUD, config, simulator, source checks, account validation, browser process controls and device doctor; Batch 60 returns a clear conflict for account deletion with bound sources | Broader browser/device lifecycle operations |
