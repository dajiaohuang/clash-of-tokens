...
function health(){
 ...
 return [pageHead('Health','Recorded outcomes, cooldowns and account capacity.'),h('h2',{},'Account health'),table(['Account','Provider','Health','Auth','In flight / limit','Sources','Success / failure','Last validated'],accountRows,'No accounts configured.'),h('h2',{},'Source health'),table(['Source','State','In flight','Success / failure','Average duration','Cooldown until'],S.config.sources.map(source=>{
